//! Maps two colored xdg toplevels to confirm cascade positioning (not fullscreen stretch).
...
fn main() -> anyhow::Result<()> {
    ...
    println!(
        "Mapped two positioned xdg SHM toplevels on {}. Visual: cascade offset, not fullscreen.",
        socket_path.display()
    );
    Ok(())
}
