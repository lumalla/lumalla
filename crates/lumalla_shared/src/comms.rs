...
impl Comms {
    ...
    /// ```
    /// # use std::sync::mpsc;
    /// # use lumalla_shared::{Comms, MainMessage, MioSender};
    /// # let (_, main_channel, to_main) = message_loop_with_channel::<MainMessage>();
    /// # let (_, _, to_display) = message_loop_with_channel::<DisplayMessage>();
    /// # let (_, _, to_renderer) = message_loop_with_channel::<RendererMessage>();
    /// # let (_, _, to_input) = message_loop_with_channel::<InputMessage>();
    /// # let (_, _, to_config) = message_loop_with_channel::<ConfigMessage>();
    ...
    /// ```
    /// # use std::sync::mpsc;
    /// # use lumalla_shared::{Comms, DisplayMessage, MioSender};
    /// # let (_, _, to_main) = message_loop_with_channel::<MainMessage>();
    ...
    /// ```
    /// # use std::sync::mpsc;
    /// # use lumalla_shared::{Comms, RendererMessage, MioSender};
    /// # let (_, _, to_main) = message_loop_with_channel::<MainMessage>();
    /// # let (_, _, to_display) = message_loop_with_channel::<DisplayMessage>();
    ...
    /// ```
    /// # use std::sync::mpsc;
    /// # use lumalla_shared::{Comms, InputMessage, MioSender};
    /// # let (_, _, to_main) = message_loop_with_channel::<MainMessage>();
    /// # let (_, _, to_display) = message_loop_with_channel::<DisplayMessage>();
    /// # let (_, _, to_renderer) = message_loop_with_channel::<RendererMessage>();
    ...
    /// ```
    /// # use std::sync::mpsc;
    /// # use lumalla_shared::{Comms, ConfigMessage, MioSender};
    /// # let (_, _, to_main) = message_loop_with_channel::<MainMessage>();
    /// # let (_, _, to_display) = message_loop_with_channel::<DisplayMessage>();
    /// # let (_, _, to_renderer) = message_loop_with_channel::<RendererMessage>();
    /// # let (_, _, to_input) = message_loop_with_channel::<InputMessage>();
